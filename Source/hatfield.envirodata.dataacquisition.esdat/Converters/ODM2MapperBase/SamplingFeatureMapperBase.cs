...
namespace Hatfield.EnviroData.DataAcquisition.ESDAT.Converters
{
    public abstract class SamplingFeatureMapperBase : ODM2MapperBase<SamplingFeature>, IODM2DuplicableMapper<SamplingFeature>
    {
        ...
        {
            Validate(entity.SamplingFeatureTypeCV, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.SamplingFeatureTypeCV)));
            Validate(entity.SamplingFeatureCode, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.SamplingFeatureCode)));
            Validate(entity.SamplingFeatureUUID, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.SamplingFeatureUUID)));
        }
