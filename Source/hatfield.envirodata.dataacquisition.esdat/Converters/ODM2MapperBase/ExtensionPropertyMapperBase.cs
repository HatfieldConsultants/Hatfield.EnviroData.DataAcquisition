...
namespace Hatfield.EnviroData.DataAcquisition.ESDAT.Converters
{
    public abstract class ExtensionPropertyMapperBase : ODM2MapperBase<ExtensionProperty>, IODM2DuplicableMapper<ExtensionProperty>
    {
        ...
        {
            Validate(entity.PropertyName, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.PropertyName)));
            Validate(entity.PropertyDataTypeCV, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.PropertyDataTypeCV)));
        }
