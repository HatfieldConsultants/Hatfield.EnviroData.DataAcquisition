...
namespace Hatfield.EnviroData.DataAcquisition.ESDAT.Converters
{
    public abstract class VariableMapperBase : ODM2MapperBase<Variable>, IODM2DuplicableMapper<Variable>
    {
        ...
        {
            Validate(entity.VariableTypeCV, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.VariableTypeCV)));
            Validate(entity.VariableCode, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.VariableCode)));
            Validate(entity.VariableNameCV, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.VariableNameCV)));
            Validate(entity.SpeciationCV, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.SpeciationCV)));
            Validate(entity.NoDataValue, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.NoDataValue)));
        }
