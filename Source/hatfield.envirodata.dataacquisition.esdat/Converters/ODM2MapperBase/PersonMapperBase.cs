...
namespace Hatfield.EnviroData.DataAcquisition.ESDAT.Converters
{
    public abstract class PersonMapperBase : ODM2MapperBase<Person>, IODM2DuplicableMapper<Person>
    {
        ...
        {
            Validate(entity.PersonFirstName, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.PersonFirstName)));
            Validate(entity.PersonMiddleName, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.PersonMiddleName)));
            Validate(entity.PersonLastName, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.PersonLastName)));
        }
