...
namespace Hatfield.EnviroData.DataAcquisition.ESDAT.Converters
{
    public abstract class ActionMapperBase : ODM2MapperBase<Core.Action>
    {
        ...
        {
            Validate(entity.ActionTypeCV, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.ActionTypeCV)));
            Validate(entity.BeginDateTime, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.BeginDateTime)));
        }
    }
}
