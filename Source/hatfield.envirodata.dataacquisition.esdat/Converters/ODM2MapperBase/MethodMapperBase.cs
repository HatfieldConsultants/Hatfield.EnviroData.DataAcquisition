...
namespace Hatfield.EnviroData.DataAcquisition.ESDAT.Converters
{
    public abstract class MethodMapperBase : ODM2MapperBase<Method>, IODM2DuplicableMapper<Method>
    {
        ...
        {
            Validate(entity.MethodTypeCV, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.MethodTypeCV)));
            Validate(entity.MethodCode, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.MethodCode)));
            Validate(entity.MethodName, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.MethodName)));
        }
