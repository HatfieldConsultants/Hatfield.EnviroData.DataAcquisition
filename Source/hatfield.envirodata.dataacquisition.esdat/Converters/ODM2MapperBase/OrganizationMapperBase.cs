...
namespace Hatfield.EnviroData.DataAcquisition.ESDAT.Converters
{
    public abstract class OrganizationMapperBase : ODM2MapperBase<Organization>, IODM2DuplicableMapper<Organization>
    {
        ...
        {
            Validate(entity.OrganizationTypeCV, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.OrganizationTypeCV)));
            Validate(entity.OrganizationCode, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.OrganizationCode)));
            Validate(entity.OrganizationName, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.OrganizationName)));
        }
