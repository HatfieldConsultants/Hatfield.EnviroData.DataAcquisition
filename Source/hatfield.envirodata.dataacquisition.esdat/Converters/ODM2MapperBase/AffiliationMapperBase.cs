...
namespace Hatfield.EnviroData.DataAcquisition.ESDAT.Converters
{
    public abstract class AffiliationMapperBase : ODM2MapperBase<Affiliation>, IODM2DuplicableMapper<Affiliation>
    {
        ...
        {
            Validate(entity.AffiliationStartDate, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.AffiliationStartDate)));
            Validate(entity.PrimaryEmail, new ODM2MapperSourceLocation(this.ToString(), GetVariableName(() => entity.PrimaryEmail)));
        }
