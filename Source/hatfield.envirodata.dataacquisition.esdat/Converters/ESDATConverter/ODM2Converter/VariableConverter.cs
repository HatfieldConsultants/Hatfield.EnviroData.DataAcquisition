...
{
    public class VariableConverter : ODM2ConverterBase
    {
        // Shared Constants
        ...
        public Variable Convert(SampleFileData sample, Result result)
        {
        ...
        public Variable Convert(ChemistryFileData chemistry, Result result)
        {
            Variable variable = new Variable();
