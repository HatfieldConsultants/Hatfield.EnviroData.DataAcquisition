...
namespace Hatfield.EnviroData.DataAcquisition.ESDAT.Converters
{
    public abstract class ODM2MapperBase<T> where T : class
    {
        ...
        private void LogInfo(string message, ODM2MapperSourceLocation location)
        {
        ...
        private void LogError(string message, ODM2MapperSourceLocation location)
        {
        ...
        private void LogErrorIfNull(object variable, ODM2MapperSourceLocation location)
        {
            if (variable == null)
            {
        ...
        protected void LogMapping(object variable, ODM2MapperSourceLocation location)
        {
        ...
        protected void Validate(object variable, ODM2MapperSourceLocation location)
        {
